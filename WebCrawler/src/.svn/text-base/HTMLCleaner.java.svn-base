...
public class HTMLCleaner {
	...
	public ArrayList<String> fetchWords(String url) {
		String html = "";
		try {
	 ...
	 * @return html code
	 */
	public static String createRequest(String urlDomain) {
		String request = "";
		request = "GET " + "//" + "HTTP/1.1\n";
		request += "Host:" + urlDomain + "\n";
		request += "Connection: close \n";
		request += "\r\n";
		return request;
	}

	public static String fetchHTML(String urlDomain) throws Exception {
