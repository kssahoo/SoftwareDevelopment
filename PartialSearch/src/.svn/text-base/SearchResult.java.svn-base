public class SearchResult implements Comparable<SearchResult>
{
	...
	/* compareTo method is overridden to compare the SearchResult objects based on the frequencies, positions and locations.  
	* This method will be later used for sorting an array list of SearchResult-s. 
	*/ 
	@Override
